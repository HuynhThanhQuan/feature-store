-- This query creates a temporary table named CINS_TMP_CARD_CREDIT_LOAN_6M_11-06-2023 that contains the customer code and a row number for each customer's credit card that was activated more than 6 months ago.
...
-- The report date is specified using the placeholder 11-06-2023.
CREATE TABLE CINS_CARD_CREDIT_LOAN_6M_11062023 AS 

-- This query creates a temporary table called CINS_TMP_DATA_RPT_CARD_12-06-2023 that contains data on card limits for each customer's most recent card.
...
CREATE TABLE CINS_DATA_RPT_CARD_12062023 AS
...
FROM (
    ...
    AND T.PROCESS_DT >= ADD_MONTHS(TO_DATE('12-06-2023', 'DD-MM-YY'), -36)

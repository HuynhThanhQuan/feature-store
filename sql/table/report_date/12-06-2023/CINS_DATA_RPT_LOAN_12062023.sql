-- This query creates a temporary table called CINS_TMP_DATA_RPT_LOAN_12-06-2023 that contains data on the most recent loan group for each customer's most recent card.
...
-- The result is stored in a temporary table with the name CINS_TMP_DATA_RPT_LOAN_12-06-2023.

CREATE TABLE CINS_DATA_RPT_LOAN_12062023 AS
...
FROM (
    ...
    WHERE T.COMPANY_KEY = 1 
        ...
        AND ADD_MONTHS(TO_DATE('12-06-2023', 'DD-MM-YY'), -6) <= T.PROCESS_DT 
        AND T.PROCESS_DT < TO_DATE('12-06-2023','DD-MM-YY')
)

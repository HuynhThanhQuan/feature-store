...
CREATE TABLE CINS_POS_TERMINAL_AMT_6M_12062023 (
...
-- This query inserts data into the CINS_POS_TERMINAL_AMT_6M_12062023 table
INSERT INTO CINS_POS_TERMINAL_AMT_6M_12062023
select E.customer_cde,
    F.MERCHANT_CDE, F.TERMINAL_ID
    ,TO_DATE('12-06-2023','DD-MM-YY') AS RPT_DT, CT_TXN_TERMINAL ,CURRENT_TIMESTAMP ADD_TSTP  
FROM
(

-- This query creates a temporary table called CINS_TMP_DATA_RPT_CARD_01-10-2023 that contains data on card limits for each customer's most recent card.
...
CREATE TABLE CINS_DATA_RPT_CARD_01102023 AS

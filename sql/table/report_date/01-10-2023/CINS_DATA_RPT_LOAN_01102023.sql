-- This query creates a temporary table called CINS_TMP_DATA_RPT_LOAN_01-10-2023 that contains data on the most recent loan group for each customer's most recent card.
...
-- The result is stored in a temporary table with the name CINS_TMP_DATA_RPT_LOAN_01-10-2023.

CREATE TABLE CINS_DATA_RPT_LOAN_01102023 AS

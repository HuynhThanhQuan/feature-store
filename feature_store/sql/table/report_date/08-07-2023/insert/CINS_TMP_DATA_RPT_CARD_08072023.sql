INSERT INTO CINS_TMP_DATA_RPT_CARD_08072023
...
FROM (
    ...
    JOIN CINS_TMP_CARD_DIM_08072023 D ON T.CARD_CDE=D.CARD_CDE
    AND SUBSTR(T.CARD_CDE,1,1) = '3'
    AND T.PROCESS_DT >= ADD_MONTHS(TO_DATE('08-07-2023', 'DD-MM-YY'), -36)

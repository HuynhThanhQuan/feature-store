...
CREATE TABLE CINS_POS_TERMINAL_AMT_6M_01102023 (
...
-- This query inserts data into the CINS_POS_TERMINAL_AMT_6M_01102023 table
INSERT INTO CINS_POS_TERMINAL_AMT_6M_01102023
select E.customer_cde,
    F.MERCHANT_CDE, F.TERMINAL_ID
    ,TO_DATE('01-10-2023','DD-MM-YY') AS RPT_DT, CT_TXN_TERMINAL ,CURRENT_TIMESTAMP ADD_TSTP  
FROM
(

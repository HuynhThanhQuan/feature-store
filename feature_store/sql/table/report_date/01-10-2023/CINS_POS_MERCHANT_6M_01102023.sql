...
CREATE TABLE CINS_POS_MERCHANT_6M_01102023 (
...
INSERT INTO CINS_POS_MERCHANT_6M_01102023
select E.customer_cde, F.MERCHANT_ID  , NULL TERMINAL_ID,TO_CHAR(TO_DATE('01-10-2023','DD-MM-YY'), 'DD-MM-YYYY') AS RPT_DT, ct_txn_pos,CURRENT_TIMESTAMP ADD_TSTP  
FROM
(

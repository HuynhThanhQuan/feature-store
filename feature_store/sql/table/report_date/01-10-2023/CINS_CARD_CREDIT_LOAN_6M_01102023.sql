-- This query creates a temporary table named CINS_TMP_CARD_CREDIT_LOAN_6M_01-10-2023 that contains the customer code and a row number for each customer's credit card that was activated more than 6 months ago.
...
-- The report date is specified using the placeholder 01-10-2023.
CREATE TABLE CINS_CARD_CREDIT_LOAN_6M_01102023 AS 

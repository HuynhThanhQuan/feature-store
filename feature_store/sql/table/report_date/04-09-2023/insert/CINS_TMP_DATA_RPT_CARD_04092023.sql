INSERT INTO CINS_TMP_DATA_RPT_CARD_04092023
...
FROM (
    ...
    JOIN CINS_TMP_CUSTOMER_04092023 C ON T.CUSTOMER_CDE=C.CUSTOMER_CDE
    JOIN CINS_TMP_CARD_DIM_04092023 D ON T.CARD_CDE=D.CARD_CDE
    AND SUBSTR(T.CARD_CDE,1,1) = '3'
    AND T.PROCESS_DT >= ADD_MONTHS(TO_DATE('04-09-2023', 'DD-MM-YY'), -36)

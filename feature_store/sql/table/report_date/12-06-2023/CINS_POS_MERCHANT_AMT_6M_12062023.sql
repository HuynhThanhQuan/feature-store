...
CREATE TABLE CINS_POS_MERCHANT_AMT_6M_12062023 (
...
/* This script inserts data into the CINS_POS_MERCHANT_AMT_6M_12062023 table by selecting the customer code, merchant ID, report date, amount billed, and timestamp from the DW_CARD_TRANSACTION_FCT and DW_CARD_MERCHANT_DIM tables. 
...
The final result is inserted into the CINS_POS_MERCHANT_AMT_6M_12062023 table.
*/

INSERT INTO CINS_POS_MERCHANT_AMT_6M_12062023 
select E.customer_cde, F.MERCHANT_ID  , NULL TERMINAL_ID,TO_CHAR(TO_DATE('12-06-2023','DD-MM-YY'), 'DD-MM-YYYY') AS RPT_DT, AMT_BILL,CURRENT_TIMESTAMP ADD_TSTP  
FROM (

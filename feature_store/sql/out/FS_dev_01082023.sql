...
CREATE TABLE CINS_TMP_CUSTOMER_STATUS_01082023 (
    CUSTOMER_CDE VARCHAR2(25 BYTE),
...
/*
Table Name: CINS_TMP_CUSTOMER_STATUS_01082023
Derived From: 
  ...
  CINS_TMP_CUSTOMER_01082023: 
    - CUSTOMER_CDE
*/
INSERT INTO CINS_TMP_CUSTOMER_STATUS_01082023
...
FROM (
    ...
    RIGHT JOIN CINS_TMP_CUSTOMER_01082023 C ON T.CUSTOMER_CDE=C.CUSTOMER_CDE
    WHERE 
        T.PROCESS_DT = ADD_MONTHS(TO_DATE('01-08-2023', 'DD-MM-YY'), -1)
        OR T.PROCESS_DT = TO_DATE('01-08-2023', 'DD-MM-YY')
    GROUP BY 
        T.CUSTOMER_CDE, 
        T.PROCESS_DT
) A;
...
Derived From: 
  CINS_TMP_CUSTOMER_STATUS_01082023: 
    - CUSTOMER_CDE 
    - CUST_STT 
    - CUST_STT_CHG 
    - RPT_DT

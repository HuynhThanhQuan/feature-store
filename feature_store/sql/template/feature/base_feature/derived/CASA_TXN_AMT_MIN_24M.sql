/*
Feature Name: CASA_TXN_AMT_MIN_24M
Derived From:
...
SELECT
    ...
    'CASA_TXN_AMT_MIN_24M' AS FTR_NM,
    NVL(MIN(ABS(TXN.AMT_LCY)), 0) AS FTR_VAL,
...
WHERE TXN.PRODUCT_CATEGORY LIKE '10__'
    ...
    AND TXN.PROCESS_DT >= ADD_MONTHS(TO_DATE('{RPT_DT}', 'DD-MM-YY'), -24)

QUERY_CUSTOMER_CDE_RPT_DT = """
    SELECT DISTINCT CUSTOMER_CDE FROM CINS_REACTIVATED_CREDIT_CUSTOMER_%s
"""
...
QUERY_RAW_DATA_FROM_FEATURE_STORE = """
    ...
    RIGHT JOIN CINS_REACTIVATED_CREDIT_CUSTOMER_%s T2 ON T1.CUSTOMER_CDE = T2.CUSTOMER_CDE
...
QUERY_CREATE_CUSTOMER_SCORE_TABLE = """
    CREATE TABLE CINS_REACTIVATED_CREDIT_SCORE_%s (
...
QUERY_DROP_CUSTOMER_SCORE_TABLE = """
    DROP TABLE CINS_REACTIVATED_CREDIT_SCORE_%s
"""


QUERY_INSERT_CUSTOMER_SCORE = """
    INSERT INTO CINS_REACTIVATED_CREDIT_SCORE_%s (CUSTOMER_CDE, SCORE)
    VALUES (:1, :2)
"""
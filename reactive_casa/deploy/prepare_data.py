...
class DataHandler:
    ...
    def init(self):
        ...
        if not os.path.exists(self.report_date_loc):
            ...
            logger.info(f'Reload {self.report_date} folder data')
    ...
    def download_raw_feature_data(self):
        ...
        logger.info(f'Prepare loading raw feature data of {self.report_date}')
    ...
    def merge_raw_feature_data(self):
        ...
        """
        logger.info(f'Merging raw feature data of {self.report_date}')
    ...
    def get_ordered_raw_feature_data(self):
        ...
        """
        logger.info(f'Prepare loading ordered-raw feature data of {self.report_date}')
    ...
    def get_formatted_raw_feature_data(self):
        ...
        """
        logger.info(f'Prepare loading formatted-raw feature data of {self.report_date}')
    ...
    def get_data_label(self, invalid_data='raise'):
        ...
        if (not self.reload_local_file) or (not os.path.exists(self.data_label_fp) or (self.overwrite_tmp_file)):
            ...
            logger.info(f'Prepare loading data-label {self.report_date}')
